    ...
    public partial class ModeltoDatabase : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HastaneInfos", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BloodPreassure = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contacts_HastaneInfos_HastaneId",
                        column: x => x.HastaneId,
                        principalTable: "HastaneInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Rooms_HastaneInfos_HastaneId",
                        column: x => x.HastaneId,
                        principalTable: "HastaneInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
