    ...
    public class RoomService : IRoomService
    {
        ...
        public PagedResult<RoomViewModel> GetAll(int pageNumber, int pageSize)
        {
            ...
            try
            {
                ...
                var modelList = _unitOfWork.GenericRepository<Room>().GetAll(includeProporties:"Hastane").Skip(ExcludeRecords).Take(pageSize).ToList();
        ...
        public void UpdateRoom(RoomViewModel Room)
        {
            ...
            ModelById.HospitalId = Room.HastaneInfoId;
