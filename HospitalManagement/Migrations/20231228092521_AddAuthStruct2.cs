...
{
    /// <inheritdoc />
    public partial class AddAuthStruct2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkingHourss", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkingHourss_Doctors_DoctorId",
                        column: x => x.DoctorId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkingHourss_DoctorId",
                table: "WorkingHourss",
                column: "DoctorId");
        }
